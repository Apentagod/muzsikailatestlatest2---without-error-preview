            ...
            <Card className="glass-card border-none rounded-xl overflow-hidden relative p-8">
              ...
              <div className="prose prose-lg max-w-none relative z-20">
                <ReactMarkdown
                  ...
                  components={{
                    h1: ({ node, ...props }) => (
                      <h1 className="text-3xl font-bold text-white font-montserrat mb-6 text-glow" {...props} />
                    ),
                    h2: ({ node, ...props }) => (
                      <h2 className="text-2xl font-bold text-white font-montserrat mt-8 mb-4 text-glow" {...props} />
                    ),
                    p: ({ node, ...props }) => (
                      <p className="text-white/90 font-montserrat mb-4" {...props} />
                    ),
                    a: ({ node, ...props }) => (
                      <a 
                    ...
                    ul: ({ node, ...props }) => (
                      <ul className="list-disc pl-6 mb-4 text-white/90" {...props} />
                    ),
                    li: ({ node, ...props }) => (
                      <li className="text-white/90 font-montserrat mb-2" {...props} />
                    ),
                  }}
                >
                  {content}
